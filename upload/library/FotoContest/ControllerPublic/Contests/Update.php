 ...
 * @author Luqman
 */
class FotoContest_ControllerPublic_Contests_Update extends FotoContest_ControllerPublic_Base
{
  public function actionRun()
  {
    ...
    $writer->setExistingData($contest, true);
    ...
    $writer->set('contest_closed', $input['contest_closed']);
    ...
    return $this->responseRedirect(
      ...
      new XenForo_Phrase('lfc_your_contest_has_been_updated')
    );
  }
}
